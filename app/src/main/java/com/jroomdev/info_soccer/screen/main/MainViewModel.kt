...
import com.jroomdev.info_soccer.base.LiveCoroutinesViewModel
import com.jroomdev.info_soccer.data.model.League
import com.jroomdev.info_soccer.data.source.repository.LeagueRepository
    ...
    init {
        leagues = getLeagues.switchMap {
            launchOnViewModelScope {
                this.leagueRepository.getLeagues(
                    page = it,
                    onSuccess = {  },
                    onError = {  },
                ).asLiveData()
